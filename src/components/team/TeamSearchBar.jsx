 ...
 * TeamSearchBar.jsx
 *
 * Controlled text input for searching teams on the teams listing
...
/**
 * Renders a controlled search input field for teams.
 ...
 */
function TeamSearchBar({ value, onChange, placeholder }) {
  return (
